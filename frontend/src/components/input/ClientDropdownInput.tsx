...
export default function ClientDropdownInput(props: ClientDropdownInputProps) {
    ...
    return (
        <div className='relative flex w-full h-fit'>
            <div
                className={`block w-full h-fit border-solid border-4 rounded-lg py-1 px-1.5 text-xl bg-white border-beige-950 ${
            ...
            <ul
                className={`absolute z-50 flex flex-col overflow-y-auto top-[110%] w-full shadow-md text-xl bg-beige-800 text-white rounded-md transition-all ${
